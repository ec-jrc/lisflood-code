...
default_options = {'EnKF': False,
                   ...
                   'reportedmaps': {'AreaTotalAbstractionFromSurfaceWaterM3': ReportedMap(
                       ...
                       'cumSeepTopToSubBOtherEnd': ReportedMap(name='cumSeepTopToSubBOtherEnd', output_var='cumSeepTopToSubBAv[0]',
                                                    ...
                                                    monthly=False, yearly=False),
                       'cumSeepTopToSubBForestEnd': ReportedMap(name='cumSeepTopToSubBForestEnd', output_var='cumSeepTopToSubBAv[1]',
                                                    unit='mm',
                                                    end=['InitLisflood'],
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),  
                       ...
                       'DirectRunoffMaps': ReportedMap(name='DirectRunoffMaps',
                                                       ...
                                                       restrictoption=['nonInit'], monthly=False,
                                                       yearly=False, scale_factor=0.006, add_offset=200.0),
                       ...
                       'ETActMaps': ReportedMap(name='ETActMaps',
                                                ...
                                                restrictoption=['nonInit'], monthly=False, yearly=False,
                                                scale_factor=0.0154, add_offset=495.0),
                       ...
                       'EWIntForestMaps': ReportedMap(name='EWIntForestMaps',
                                                      ...
                                                      restrictoption=['nonInit'], monthly=False,
                                                      yearly=False, scale_factor=3.05e-4, add_offset=10.0),
                       ...
                       'FastRunoffMaps': ReportedMap(name='FastRunoffMaps',
                                                     ...
                                                     restrictoption=['nonInit'], monthly=False,
                                                     yearly=False, scale_factor=0.0076, add_offset=250),
                       ...
                       'GwPercUZLZForestMaps': ReportedMap(name='GwPercUZLZForestMaps',
                                                           ...
                                                           restrictoption=['nonInit'], monthly=False,
                                                           yearly=False, scale_factor=4.6e-5, add_offset=1.5),
                       ...
                       'InterceptionForestMaps': ReportedMap(name='InterceptionForestMaps',
                                                             ...
                                                             restrictoption=['nonInit'], monthly=False,
                                                             yearly=False, scale_factor=2.3e-4, add_offset=7.5),
                       ...
                       'LZMaps': ReportedMap(name='LZMaps', output_var='LZ', unit='mm', end=[],
                                             ...
                                             monthly=False, yearly=False,scale_factor=0.2365, add_offset=7250.0),
                       'LZOutflowMaps': ReportedMap(name='LZOutflowMaps',
                                                    ...
                                                    restrictoption=['nonInit'], monthly=False,
                                                    yearly=False, scale_factor=	4.578e-5, add_offset=1.5),
                       'LZState': ReportedMap(name='LZState', output_var='LZ', unit='mm', end=[],
                                              steps=['repStateMaps'], all=[],
                                              restrictoption=['nonInit'], monthly=False, yearly=False,
                                              scale_factor=0.09156, add_offset=-1000.0),
                       ...
                       'PrecipitationMapsOut': ReportedMap(name='PrecipitationMapsOut',
                                                           ...
                                                           restrictoption=[], monthly=False,
                                                           yearly=False, scale_factor=0.01526, add_offset=500.),
                       ...
                       'RainMaps': ReportedMap(name='RainMaps', output_var='Rain', unit='mm',
                                               ...
                                               restrictoption=['nonInit'], monthly=False, yearly=False, 
                                               scale_factor=0.01526, add_offset=500.),
                      ...
                      'ReservoirAbstractionM3': ReportedMap(name='ReservoirAbstractionM3',
                       ...
                       'SeepSubToGWotherMaps': ReportedMap(name='SeepSubToGWOtherMaps',
                                                            ...
                                                            restrictoption=['nonInit'], monthly=False,
                                                            yearly=False, scale_factor=9.156e-4, add_offset=30.),                                                  
                       ...
                       'SnowCoverAState': ReportedMap(name='SnowCoverAState',
                                                      ...
                                                      steps=['repStateMaps'], all=[],
                                                      restrictoption=['nonInit'], monthly=False,
                                                      yearly=False, scale_factor=0.15260, add_offset=5000.),
                       ...
                       'TaOtherMaps': ReportedMap(name='TaOtherMaps', output_var='Ta[0]', unit='mm',
                                                   ...
                                                   restrictoption=['nonInit'], monthly=False,
                                                   yearly=False, scale_factor=3.815e-4, add_offset=2.5),
                       ...
                       'TaMaps': ReportedMap(name='TaMaps', output_var='TaPixel', unit='mm', end=[],
                                             ...
                                             monthly=False, yearly=False, scale_factor=3.815e-4, add_offset=2.5),
                       ...
                       'Theta1ForestMaps': ReportedMap(name='Theta1ForestMaps', output_var='Theta1a[1]',
                                                       ...
                                                       restrictoption=['nonInit'], monthly=False,
                                                       yearly=False, scale_factor=1.53e-5, add_offset=0.5),
                       ...
                       'TransLossMaps': ReportedMap(name='TransLossMaps', output_var='TransLossM3*self.var.M3toMM',
                                                 ...
                                                 yearly=False, scale_factor=0.009156, add_offset=300.),                                                                       
                       ...
                       'UZForestMaps': ReportedMap(name='UZForestMaps', output_var='UZ[1]', unit='mm',
                                                   ...
                                                   restrictoption=['nonInit'], monthly=False,
                                                   yearly=False, scale_factor=0.05341, add_offset=1750.),
                       ...
                       'UZIrrigationMaps': ReportedMap(name='UZIrrigationMaps', output_var='UZ[2]',
                                                       ...
                                                       monthly=False, yearly=False, scale_factor=0.05341, add_offset=1750.),
                       ...
                       'UZOutflowForestMaps': ReportedMap(name='UZOutflowForestMaps',
                                                          ...
                                                          restrictoption=['nonInit'], monthly=False,
                                                          yearly=False, scale_factor=0.004578, add_offset=150.),
                       ...
                       'UZState': ReportedMap(name='UZState', output_var='UZ[0]', unit='mm', end=[],
                                              steps=['repStateMaps'], all=[],
                                              restrictoption=['nonInit'], monthly=False, yearly=False,
                                              scale_factor=0.05341, add_offset=1750.),
                       ...
                       'WaterDepthState': ReportedMap(name='WaterDepthState', output_var='WaterDepth',
                                                      unit='m', end=[], steps=[],
                                                      all=[], restrictoption=['nonInit'],
                                                      monthly=False, yearly=False, scale_factor=0.003815, add_offset=125.),
                       'TotalWaterStorageMaps': ReportedMap(name='TotalWaterStorageMaps',
                                                            output_var='TotalWaterStorageMM',
                                                            unit='mm', end=[], steps=[],
                                                            all=['repTotalWaterStorageMaps'],
                                                            restrictoption=['nonInit'],
                                                            monthly=False, yearly=False, scale_factor=534.4, add_offset=17497500.0),
                   ...
                   'timeseries': {
                       ...
                       'Theta3TS': TimeSeries(name='Theta3TS',
                                                 ...
                                                 where='Sites', repoption=['repStateSites'], restrictoption=['nonInit'],
                                                 operation=['']),
                       'abstractionGWactualTS' : TimeSeries(name='abstractionGWactualTS', output_var='abstraction_GW_actual_M3*self.var.M3toMM',
                                                        where='Gauges', repoption=['repRateUpsGauges'],
                                                        restrictoption=['nonInit', 'wateruse'],
                                                        operation=['total']),   
                       'withdrawalSWactualTS': TimeSeries(name='withdrawalSWactualTS', output_var='withdrawal_SW_actual_M3*self.var.M3toMM',
                                                        where='Gauges', repoption=['repRateUpsGauges'],
                                                        restrictoption=['nonInit','wateruse'], operation=['total']), 
                       'withdrawalCHactualTS': TimeSeries(name='withdrawalCHactualTS', output_var='withdrawal_CH_actual_M3*self.var.M3toMM', where='Gauges',
                                           repoption=['repRateUpsGauges'], restrictoption=['nonInit','wateruse'], operation=['total']),                                             
                       'withdrawalReservoirsTS': TimeSeries(name='withdrawalReservoirsTS', output_var='ReservoirAbstractionM3*self.var.M3toMM',
                                                        where='ReservoirSites', repoption=['repsimulateReservoirs','repRateUpsGauges'],
                                                        restrictoption=['nonInit', 'simulateReservoirs','wateruse'],
                                                        operation=['']),     
                       'withdrawalLakesTS': TimeSeries(name='withdrawalLakesTS', output_var='LakeAbstractionM3*self.var.M3toMM',
                                                        where='LakeSites', repoption=['repsimulateLakes','repRateUpsGauges'],
                                                        restrictoption=['nonInit','wateruse', 'simulateLakes'], operation=['']),                                                        
                       'areatotalshortageSWTS': TimeSeries(name='areatotalshortageSWTS', output_var='areatotal_shortage_SW_M3*self.var.M3toMM',
                                                        where='Gauges', repoption=['repRateUpsGauges'],
                                                        restrictoption=['nonInit','wateruse'], operation=['total']), 
                       'returnflowGwAbs2ChannelTS' : TimeSeries(name='returnflowGwAbs2ChannelTS', output_var='returnflow_GwAbs2Channel_M3_routStep*self.var.M3toMM',
                                                        where='Gauges', repoption=['repRateUpsGauges'],
                                                        restrictoption=['nonInit', 'wateruse'],
                                                        operation=['total']),
                       'TransLossTS' : TimeSeries(name='TransLossTS', output_var='TransLossM3*self.var.M3toMM',
                                                        where='Gauges', repoption=['repRateUpsGauges'],
