...
# --------------------------------------------------------------------------
    ...
    def dynamic(self):
        ...
        # potential evaporation (as for water bodies)
        ...
        # potential interception storage
        self.var.InterSealed = np.minimum(self.var.InterSealed, self.var.RainSnowmelt)
        # Interception in depressions storage (in [mm] per time step);
        ...
        # potential evaporation from depression storages
