...
# --------------------------------------------------------
    ...
    def dynamic(self):
        ...
        self.var.abstraction_SW_required_M3 = abstraction_SW_required_domestic_M3 + abstraction_SW_required_livestock_M3 +\
                                              abstraction_SW_required_industry_M3 + abstraction_SW_required_energy_M3 +\
                                              abstraction_SW_required_irrigation_M3 + self.var.PaddyRiceWaterAbstractionFromSurfaceWaterM3
        self.var.abstraction_SwGw_required_M3 = self.var.abstraction_SW_required_M3 + abstraction_GW_required_irrigation_M3 +\
                                                abstraction_GW_noReturn_M3
