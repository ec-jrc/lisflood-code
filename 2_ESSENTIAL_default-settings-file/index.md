...
# Main sections of the default settings file
...
As explained in the [technical layout of the settings file](https://ec-jrc.github.io/lisflood-code/2_ESSENTIAL_setting-file/), the 'lfoptions' element gives you additional control over what LISFLOOD is doing. Using options it is possible to switch certain parts of the model on or off. This way you can tell the model exactly which output files are reported and which ones aren't. Also, they can be used to activate a number of additional model features, such as the simulation of reservoirs and inflow hydrographs.
