...
| percolation lower soil layer to groundwater (upper zone) | repSeepSubToGWMaps     | $\frac{mm}{timestep}$      | SeepSubToGWMaps <br> SeepSubToGWotherMaps <br> SeepSubToGWforestMaps <br> SeepSubToGWirrigationMaps                                    | sgwPixel <br> sgwOther <br> sgwForest <br> sgwIrrigation          |
