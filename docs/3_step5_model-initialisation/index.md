...
***Figure:** Simulation of soil moisture in the upper soil layer for a soil that is initially at saturation ($s$), at residual moisture content ($r$) and in between ($\frac{s+r}{2}$).*
