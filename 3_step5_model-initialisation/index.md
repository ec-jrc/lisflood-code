...
This optional, extensive initialization has been implemented in OS-LISFLOOD v4.0.0. The interested users should then use [this settings](../media/lisfloodSettings_reference_coldstart_optional_init_v4.0.0.xml) file as template to prepare their own initialization run and cold start. Please note that the content of this paragraph does not apply to the runs with warm start! <br>
