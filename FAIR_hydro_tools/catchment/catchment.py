...
#$ python2 catchment.py /DATA/gelatem/FAIR_workshop/Lisflood01degree/maps_netcdf/ldd.nc /DATA/gelatem/FAIR_workshop/recipes_auxiliary_datasets/Lorentz_Basin_Shapefiles/ /DATA/gelatem/FAIR_workshop/areamaps/lorentz_6.nc
