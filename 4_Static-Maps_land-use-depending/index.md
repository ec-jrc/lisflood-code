...
|Manning's coefficient|mannings_**T**.nc; Type: Float32|Units: m<sup>1/3<endsup>s<sup>-1<endsup>; <br> Range: 0.015 .. 0.200|Averaged (by ecosystem type) Manning’s roughness coefficient for forest/ irrigated crops/ other land cover type|
